...
// class GB_PPU_GC9A01 : public PPU
{
private:
public:
    // GB_PPU_GC9A01(std::shared_ptr<Memory> memory) : PPU(memory){}
    GB_PPU_GC9A01(std::shared_ptr<Memory> memory, GC9A01& display) : PPU(memory), GC9A01(display) {}
